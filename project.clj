...
(defproject io.pedestal/pedestal "0.5.8-SNAPSHOT"
  ...
  :profiles {:docs {:plugins [[lein-codox "0.9.5"]]
                    :dependencies [[io.pedestal/pedestal.log "0.5.8-SNAPSHOT"]
                                   ...
                                   [io.pedestal/pedestal.aws "0.5.8-SNAPSHOT"]
                                   [io.pedestal/pedestal.service-tools "0.5.8-SNAPSHOT"]]
