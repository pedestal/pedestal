...
<5> The path to the SSL certificate file.
...
<7> Disable the Server Name Indication check when running on localhost or when using a DNS wildcard certificate.  Default is true and you should not change this unless you need to.
...
You can now interact with the started service.  Open a web browser to http://localhost:8080/ and https://localhost:8080/
