...
You may see slightly different results, but the takeaway is that you can look
...
converted into sequences of several characters.  There's also delimiters between
