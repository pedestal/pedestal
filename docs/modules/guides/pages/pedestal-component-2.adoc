...
As you imagine xref:pedestal-with-component.adoc[Component-based Pedestal application] expanding
ins functionality, you might expect to see some growing pains.
...
It also quietly adds an implementation of api:IntoInterceptor[].
