...
Pedestal includes effective support for handling content type issues on
...
Using the update style is more concise than our prior code, and, to a more experienced Clojure developer, often
more readable.
