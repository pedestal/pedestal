...
https://github.com/pedestal/pedestal/issues?q=state%3Aopen%20label%3Aprimed[primed label] in our issues.

Less defined tasks will be marked with the
https://github.com/pedestal/pedestal/issues?q=state%3Aopen%20label%3Adiscuss[discuss
