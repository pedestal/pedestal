...
Some error should not be logged; by default, Pedestal will identify
...
This logic can be altered using the xref:service-map.adoc[]'s :io.pedestal.http/service-fn-options key;
