...
The api:*[] namespace contains additional protocols and functions related to metrics and tracing; these are
deprecated in Pedestal 0.7 and have been replaced with new APIs built around {otel}; the deprecated functions
will be removed in a future Pedestal release.
