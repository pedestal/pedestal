...
| :thread-pool
| A link:https://javadoc.jetty.org/jetty-11/org/eclipse/jetty/util/thread/ThreadPool.html[ThreadPool] instance.
...
| :ssl-context-factory
| An link:https://javadoc.jetty.org/jetty-11/org/eclipse/jetty/util/ssl/SslContextFactory.html[SslContextFactory] instance.
...
| An link:https://javadoc.jetty.org/jetty-11/org/eclipse/jetty/server/HttpConfiguration.html[HttpConfiguration] instance.
