...
(ns io.pedestal.service.http.jetty-test
  (:use clojure.test
...
(defhandler echo-handler [request]
  {:status 200
   :headers {"request-map" (str (dissoc request
                                        ...
                                        :servlet-response
                                        :servlet-context
                                        :pedestal.service.http.impl.servlet-interceptor/protocol
                                        :pedestal.service.http.impl.servlet-interceptor/async-supported?))}
   :body (:body request)})
  ...
  (testing "HTTPS server"
    (with-server hello-world {:port 4347
                              :jetty-options {:ssl-port 4348
                                              :keystore "test/io/pedestal/service/http/keystore.jks"
