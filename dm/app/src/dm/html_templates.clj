(ns dm.html-templates
  (:use [io.pedestal.app.templates :only [tfn dtfn tnodes]]))

(defmacro dm-templates
  []
  ;; Extract the 'hello' template from the template file dm.html.
  ...
  {:dm-page (dtfn (tnodes "dm.html" "hello") #{:id})})
